<template>
  <div>
    <a> this is my example!</a>
    <ul>
      <li v-bind:key=url.id v-for="url in urlList">url : {{ url.url }}</li>
    </ul>
    <!--    Using bootstrap icons from (https://icons.getbootstrap.com/) -->
    <i class="bi-alarm"></i>
    <i class="bi-github" role="img" aria-label="GitHub"></i>
    <i class="bi bi-balloon-heart-fill" aria-hidden="true"></i>
    <!--    Using bootstrap examples (https://getbootstrap.com/docs/5.1/utilities/display/#examples) -->
        ...
        <ul class="list-unstyled">
          <li class="my-2">
            <button class="btn d-inline-flex align-items-center collapsed" data-bs-toggle="collapse"
                    aria-expanded="false" data-bs-target="#contents-collapse" aria-controls="contents-collapse">Contents
            </button>
          ...
          <li class="my-2">
            <button class="btn d-inline-flex align-items-center collapsed" data-bs-toggle="collapse"
                    aria-expanded="false" data-bs-target="#forms-collapse" aria-controls="forms-collapse">Forms
            </button>
